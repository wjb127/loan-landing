          ...
          <div className="prose max-w-none text-gray-700 space-y-6">
            <div className="bg-blue-50 p-4 rounded-lg border border-blue-200">
              <p className="text-sm font-medium text-blue-800">
                &lsquo;주식회사 에이스대부중개법인&rsquo;(이하 &ldquo;회사&rdquo;라 함)는 신용정보의 이용 및 보호에 관한 법률, 정보통신망 이용촉진 및 정보보호 등에 관한 법률, 통신비밀보호법, 전기통신사업법, 개인정보보호법, 대부중개업 등의 등록 및 금융이용자 보호에 관한 법률 등 준수하여야 할 관련 법규상의 개인정보보호규정을 준수하며, 다음과 같이 개인정보처리방침을 정하여 이용자(이하 &ldquo;고객&rdquo;)의 권익보호에 최선을 다하고 있습니다.
              </p>
