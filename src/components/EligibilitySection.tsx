    ...
    <div className="space-y-12">
      ...
      <div>
        ...
        <div className="space-y-4">
          <div>
            <span className="text-blue-600 font-semibold">자격대상: </span>
            <span className="text-gray-700">만 24세 이상의 소득확인이 가능한 자</span>
          </div>
          <div>
            <span className="text-blue-600 font-semibold">신청방법: </span>
            <span className="text-gray-700">하단 신청란에 신청 가능 (무방문, 무서류 당일승인)</span>
          </div>
          <div>
            <span className="text-red-600 font-semibold">신청불가 대상: </span>
            <span className="text-red-600">연체, 회생, 회복, 파산 이력자는 지원이 불가능합니다.</span>
          </div>
        </div>
      </div>
