export default function Footer() {
  return (
    <footer className="text-slate-200 py-8 mb-32 md:mb-48" style={{ backgroundColor: '#132458' }}>
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 text-sm">
          ...
          {/* 상환 방법 및 주의사항 */}
          <div className="space-y-2">
            <div className="text-white font-semibold mb-3">상환 및 주의사항</div>
            <div>
              <strong>상환방법:</strong><br/>
              원리금균등상환방식, 만기일시상환방식
            </div>
            <div className="text-red-300 font-medium mt-3">
        ...
        <div className="border-t border-slate-600 mt-6 pt-6">
          <div className="border border-amber-400 border-opacity-30 p-4 rounded-lg" style={{ backgroundColor: 'rgba(19, 36, 88, 0.8)' }}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
              ...
              <div className="border border-amber-400 border-opacity-40 p-3 rounded" style={{ backgroundColor: 'rgba(10, 20, 50, 0.9)' }}>
