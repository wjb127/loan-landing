export default function HeroSection() {
  return (
    <section className="min-h-screen relative overflow-hidden" style={{ backgroundColor: '#132458' }}>
      ...
      <div className="max-w-6xl mx-auto px-4 pt-16 pb-16 relative z-10">
        ...
        <div className="text-center mb-6">
          <div className="inline-block border-2 border-amber-400 border-opacity-70 rounded-full px-8 py-3 text-white text-sm backdrop-blur-sm" style={{ backgroundColor: 'rgba(19, 36, 88, 0.8)' }}>
주식회사 에이스합동 등록번호 2025-대구남구-0006
        ...
        <div className="border border-amber-400 border-opacity-70 rounded-xl p-8 max-w-4xl mx-auto shadow-2xl backdrop-blur-md" style={{ backgroundColor: 'rgba(19, 36, 88, 0.95)' }}>
