      ...
      <div className="max-w-6xl mx-auto px-4 pt-8 md:pt-16 pb-16 relative z-10">
        ...
        <div className="border-2 border-blue-900 rounded-xl max-w-4xl mx-auto shadow-2xl backdrop-blur-md animate-scaleIn animation-delay-200 overflow-hidden" style={{backgroundColor: 'rgba(255, 255, 255, 0.95)'}}>
          <div className="grid grid-cols-3">
            {/* 금리 섹션 */}
            <div className="p-2 md:p-8 text-center border-r border-white animate-fadeIn animation-delay-250">
              <div className="text-sm md:text-xl font-bold mb-1 md:mb-3 text-blue-900">금리</div>
              <div className="text-xs md:text-base text-gray-700 whitespace-nowrap">최저 연 <span className="text-xs md:text-2xl font-bold text-blue-900">3.9%</span> 부터</div>
            </div>
