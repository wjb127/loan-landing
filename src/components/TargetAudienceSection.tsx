      ...
      <div className="block md:hidden">
        ...
        <div className="flex items-center justify-center mb-8">
          ...
          <div className="text-left">
            <h2 className="text-2xl font-bold text-gray-900 mb-2">근로자 안심대출</h2>
            <h3 className="text-2xl font-bold text-blue-900">신청 대상자</h3>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <div className="flex items-center mb-8">
                ...
                <div className="text-left">
                  <h2 className="text-3xl font-bold text-gray-900 mb-2">근로자 안심대출</h2>
                  <h3 className="text-3xl font-bold text-blue-900">신청 대상자</h3>
                </div>
              </div>
